...
/*
 * Copyright (c) 2009-2012,2015 Wind River Systems, Inc.
 *
...
-------------------- 
01g,18jun15,zly  ACMD42 is not included in SD card driver.(VXW6-84329)
...
#define SDMMC_CMD_RSP_CMDIDX    0x00000010
#define SDMMC_CMD_RSP_CRC       0x00000004
#define SDMMC_CMD_RSP_BUSY      0x00000008
...
#define SDMMC_CMD_RSP_R2       (SDMMC_CMD_RSP_LEN136 | SDMMC_CMD_RSP_CRC | SDMMC_CMD_RSP_LEN48)
...
#define SDMMC_CLK_FREQ_10MHZ        10000000
